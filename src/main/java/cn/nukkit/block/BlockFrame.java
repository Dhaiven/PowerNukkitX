...
public class BlockFrame extends BlockTransparent implements BlockEntityHolder<BlockEntityItemFrame>, Faceable {
    ...
    public boolean onActivate(@NotNull Item item, Player player, BlockFace blockFace, float fx, float fy, float fz) {
        ...
        if (itemFrame.getItem().isNull()) {
            ...
            this.getLevel().addLevelEvent(this, LevelEventPacket.Event.SOUND_ITEM_FRAME_ITEM_ADDED);
        } else {
            ...
            this.getLevel().addLevelEvent(this, LevelEventPacket.Event.SOUND_ITEM_FRAME_ITEM_ROTATED);
        }
        return true;
    }
    ...
    public boolean onBreak(Item item) {
        ...
        this.getLevel().addLevelEvent(this, LevelEventPacket.Event.SOUND_ITEM_FRAME_REMOVED);
        return true;
    }
