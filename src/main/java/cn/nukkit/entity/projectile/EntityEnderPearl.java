...
public class EntityEnderPearl extends EntityProjectile {
    ...
    private void teleport() {
        ...
        this.level.addLevelEvent(this.shootingEntity.add(0.5, 0.5, 0.5), LevelEventPacket.Event.SOUND_PORTAL);
        ...
        this.level.addLevelEvent(this, LevelEventPacket.Event.PARTICLE_ENDERMAN_TELEPORT);
        this.level.addLevelEvent(this.shootingEntity.add(0.5, 0.5, 0.5), LevelEventPacket.Event.SOUND_PORTAL);
    }
